    ...
    const renderJobItem = ({ item }) => {
        ...
        return (
            <TouchableOpacity onPress={() => {
                ...
                <View style={{ marginTop: 13, flexDirection: 'row', alignItems: 'center', marginStart: 10, marginEnd: 10, padding: 10 ,borderBottomWidth:2,borderBottomColor:Colors.dark_gray}}>
                  
                    <View style={{ flex: 1}}>
                        <Text style={{ color: Colors.textcolor, fontWeight: 'bold', fontSize: 16 }}>Details</Text>
                        <Text style={{ color: Colors.textcolor, fontWeight: 'medium', fontSize: 12 }}>Start Date - {new Date(item.start_date).toDateString()}</Text>
                        <Text style={{ color: Colors.textcolor, fontWeight: 'medium', fontSize: 12 }}>End Date - {new Date(item.end_date).toDateString()}</Text>
