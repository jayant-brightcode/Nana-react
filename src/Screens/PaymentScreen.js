...
import { View, StyleSheet, StatusBar, Image, Text, Dimensions, FlatList, TouchableOpacity, ActivityIndicator } from 'react-native'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.background_shape}>
                <View style={{ flexDirection: 'row', padding: 20, alignItems: 'center' }}>
                    <Image style={{ width: 17, height: 17 }} source={require('../../assets/images/arrow.png')} />
