    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View >
          ...
          <TextInput style={{backgroundColor:Colors.grayview,borderRadius:10,padding:10}} placeholder="Enter your Registered Email here" value={email} onChangeText={(text) => setEmail(text)} />
