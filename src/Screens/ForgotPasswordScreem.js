...
const ForgotPasswordScreen = () => {
  ...
  // return;
    ...
    if (!email.trim()) {
      Toast.show({
        type: 'success',
        text1: `Please enter email address or phone number`,
      });
      return;
    }
    ...
    try {
      ...
      setLoading(true)
      const apiUrl = Remote.BASE_URL+"user/send_reset_password_mail";
      ...
      if(!isValidPhone(email)){
           if(!isValidEmail(email)){
            ...
            Toast.show({
              type: 'success',
              text1: "Enter valid email or phone number",
            });
            return
           }
      }
      ...
      if (response.ok) {
        ...
        navigation.navigate("ForgotPasswordOtpScreen", { cred: data })
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View >
          ...
          <TextInput style={{backgroundColor:Colors.grayview,borderRadius:10,padding:10}} placeholder="Enter your Registered Email/Phone here" value={email} onChangeText={(text) => setEmail(text)} />
