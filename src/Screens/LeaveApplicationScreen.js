                    ...
                    <View style={{ flex: 1, marginTop: 10 }}>
                       ...
                       {get_id.toString()==item.to_user_id._id.toString() && item.application_status=="leave application sent" && (
                                ...
                                <TouchableOpacity onPress={()=>{
                                    ...
                                    <Text style={{padding:10,backgroundColor:Colors.orange,width:80,textAlign:'center',color:Colors.white}}>Accept</Text>
                                    </TouchableOpacity>
                                    ...
                                    <Text style={{marginStart:10,padding:10,backgroundColor:Colors.navcolor,width:80,textAlign:'center',color:Colors.white}}>Reject</Text>
                                    </TouchableOpacity>
