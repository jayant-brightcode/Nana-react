    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ height: 120,backgroundColor:Colors.orange }}>
                ...
                <Image style={{ width: 150, height: 150,alignSelf:'center',marginTop:'10%' }} source={require('../../assets/images/profile.png')}></Image>
                ...
                <View>
                    ...
                    <FlatList style={{ marginTop: 10, marginBottom: 20 }}
                        ...
                        renderItem={({ item }) => (
                            ...
                            >
                                <Text style={[{ fontSize: 18 }, { color: selectedItem === item ? Colors.textcolor : Colors.dark_gray }, { fontWeight: selectedItem === item ? 'bold' : 'medium' }]}>{item.name}</Text>
                                <Image
                                    source={selectedItem === item ? require('../../assets/images/green_right.png') : require('../../assets/images/blue_right.png')}
                                    style={{ width: 20, height: 20 }}
                                />
