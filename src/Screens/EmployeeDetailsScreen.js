...
import { View, Text, StyleSheet, Image, FlatList, TouchableOpacity,TextInput,TouchableWithoutFeedback,Modal } from 'react-native'
    ...
    const renderRecentSearch = ({ item }) => {
        ...
        return (
          ...
          <View style={{ marginTop: 13, flexDirection: 'row', alignItems: 'center', marginStart: 10, marginEnd: 10, backgroundColor: Colors.grayview, borderRadius: 10 }}>
                    ...
                    >
                    <Image style={{ width: 50, height: 50, resizeMode: 'center' }} source={require('../../assets/images/profile.png')} />
                    </View>
                    <View style={{ flex: 1, marginLeft: 14 }}>

                        <Text style={{ color: Colors.textcolor, fontWeight: 'bold', fontSize: 16 }}>Jayant</Text>
                        <Text style={{ color: Colors.textcolor, fontWeight: 'medium', fontSize: 12 }}>nice works</Text>
                    <AirbnbRating
                        ...
                        size={10} // Size of the rating items
