...
const ProfileScreen = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Text style={{ color: Colors.dark_gray, fontWeight: 'light', fontSize: 14, marginTop: 3, marginStart: 3,alignSelf:'center' }}>Member ID</Text>
                            ...
                            <View style={{ margin: 10 }}>
                                ...
                                <View style={{flexDirection:'row'}}>
                                    <TouchableOpacity style={{ backgroundColor: Colors.grayview, padding: 10, borderRadius: 10, width: 80 }} onPress={()=>{
                                            ...
                                            navigation.navigate("WorkDashboardScreen", { data: data })
                                    }}>
