...
const AboutScreen = () => {
    ...
    const navigation = useNavigation()
     ...
     const htmlContent = `<html><head><style>body { font-size: 44px; }</style></head><body>${about}</body></html>`;
    ...
    const get_about = async () => {
        ...
        try {
            ...
            let apiUrl = Remote.BASE_URL + "about_us"
           ...
           <View style={styles.topbar}>
            <View style={{ flexDirection: 'row', marginTop: Platform.OS=="android"?10:0, padding: 10, alignItems: 'center' }}>
                ...
                <View style={{ marginStart: 15, flex: 1 }}>
                    <Text style={{ color: Colors.white, fontWeight: 'bold', fontSize: 20 }}>About Us</Text>
