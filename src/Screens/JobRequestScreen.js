                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            {item.from_user_id._id.toString() == get_id.toString() && item.application_status == "accepted by user" &&  item.job_pref.name=="Daily Service" &&(
                                ...
                                <TouchableOpacity style={styles.button1} onPress={() => {
                                    ...
                                    <Text style={{fontSize:11,color:Colors.textcolor}}>Per/day price set - {item.to_user_id.average_price} </Text>
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10 }}>
                                        <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white }}>Pay Platform fee Rs.{item.job_pref.platform_charge}</Text>
                    ...
                    <View style={styles.dialogContainer}>
                        ...
                        <View style={styles.buttonContainer}>
                            <TouchableOpacity style={styles.button} onPress={handleCallNow}>
                                <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white, borderRadius: 10 }}>Call Now</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={styles.button} onPress={chatHandler}>
                                <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white, borderRadius: 10 }}>Chat</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style={styles.button} onPress={handleDirection}>
                                <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white,borderRadius:10 }}>Direction</Text>
                            </TouchableOpacity>
                    ...
                    <View style={styles.dialogContainer}>
                        ...
                        <View style={styles.buttonContainer}>
                            <TouchableOpacity style={styles.button} onPress={handleSetPrice}>
                                <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white }}>Accept Request</Text>
                            </TouchableOpacity>
