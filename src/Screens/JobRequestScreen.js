            ...
            <TouchableOpacity onPress={() => {
                ...
                <View style={{ marginTop: 13, flexDirection: 'row', marginStart: 10, marginEnd: 10, borderRadius: 10, padding: 10,borderBottomColor:Colors.dark_gray,borderBottomWidth:1 }}>
                    ...
                    <View style={{ flex: 1, marginLeft: 14, marginTop: 10 }}>
                        ...
                        <Text style={{ color: Colors.textcolor, fontWeight: 'bold', fontSize: 16 }}>{item.from_user_id._id==get_id.toString() ? item.to_user_id.name:item.from_user_id.name}</Text>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            {item.from_user_id._id.toString() == get_id.toString() && item.application_status == "accepted by user" &&  item.job_pref.name=="Daily Service" &&(
                                ...
                                <TouchableOpacity style={styles.button1} onPress={() => {
                                    ...
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10,borderRadius:10 }}>
                                        <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white,borderRadius:10}}>Pay Platform fee Rs.{item.job_pref.platform_charge}</Text>
                            ...
                            {item.from_user_id._id.toString() == get_id.toString() && item.application_status == "accepted by user" && item.job_pref.name == "Monthly Job"  && (
                                ...
                                <TouchableOpacity style={styles.button1} onPress={() => {
                                    ...
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10 }}>
                                        <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white,borderRadius:10,overflow:'hidden'}}>view detail</Text>
                                        {/* <Image source={require('../../assets/images/back.png')} style={styles.icon} /> */}
                                    </View>
                                </TouchableOpacity>)}    
                            ...
                            {item.from_user_id._id.toString() == get_id.toString() && item.application_status == "accepted by user" && item.job_pref.name == "Monthly Job"  && item.is_joined == false && (
                                ...
                                <TouchableOpacity style={styles.button1} onPress={() => {
                                    ...
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10 }}>
                                        <Text style={{ backgroundColor: Colors.navcolor, marginStart: 10, padding: 10, color: Colors.white,borderRadius:10,overflow:'hidden' }}>start work</Text>
                                        {/* <Image source={require('../../assets/images/back.png')} style={styles.icon} /> */}
                                    </View>
                                </TouchableOpacity>)}
                            ...
                            {item.from_user_id._id.toString() == get_id.toString() && item.application_status == "user joined" && item.is_joined == true && item.job_pref.name == "Daily Service"  && (
                                ...
                                <TouchableOpacity style={styles.button1} onPress={() => {
                                    ...
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10 }}>
                                        <Text style={{ backgroundColor: '#68BBE3', padding: 10, color: Colors.white ,borderRadius:10,overflow:'hidden'}}>complete work</Text>
                                        {/* <Image source={require('../../assets/images/back.png')} style={styles.icon} /> */}
                                    </View>
                                </TouchableOpacity>)}
                            ...
                            {item.from_user_id._id.toString() == get_id.toString() && item.application_status == "request sent" && (
                                ...
                                <TouchableOpacity style={styles.button1} onPress={() => {
                                    ...
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10 }}>
                                        <Text style={{ backgroundColor: Colors.red, padding: 10, color: Colors.white,borderRadius:10,overflow:'hidden' }}>Cancel</Text>
                                        {/* <Image source={require('../../assets/images/back.png')} style={styles.icon} /> */}
                                    </View>
                                </TouchableOpacity>)}
                            ...
                            {item.to_user_id._id.toString() == get_id.toString() && item.application_status == "request sent" && (
                                ...
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <View style={{ width: '100%', marginTop: 10, marginBottom: 10 }}>
                                        <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white ,borderRadius:10}}>Accept</Text>
                                        {/* <Image source={require('../../assets/images/back.png')} style={styles.icon} /> */}
                                    </View>
                                </TouchableOpacity>)}
    ...
    return (
        <View style={styles.container}>
            ...
            <Modal visible={is_price_DialogVisible} animationType="slide" transparent>
                <View style={styles.modalContainer}>
                    <View style={styles.dialogContainer}>
                        <Text style={{ color: Colors.black, alignSelf: 'center', marginBottom: 20, fontWeight: 'bold' }}>Choose Price/Day</Text>
                        ...
                        <View style={styles.buttonContainer}>
                            <TouchableOpacity style={styles.button} onPress={handleSetPrice}>
                                <Text style={{ backgroundColor: Colors.orange, padding: 10, color: Colors.white,borderRadius:10 }}>Accept Request</Text>
                            </TouchableOpacity>
