    ...
    const renderCategoryList = ({ item }) => (
        ...
        <TouchableOpacity onPress={() => {
            ...
            <View style={[styles.cat_item]}>
                ...
                {console.log(Remote.BASE_URL + item.image)}
            </View>
        </TouchableOpacity>
        ...
        <View style={styles.container} >
            ...
            <View style={styles.topbar}>
                <View style={{ flexDirection: 'row', marginTop: 10, padding: 10 }}>
                    ...
                    <Image style={{ width: 50, height: 50 }} source={require('../../assets/images/profile.png')} ></Image></TouchableOpacity>
                    ...
                    <View style={{ flexDirection: 'row', width: 100, marginTop: 10, padding: 10, justifyContent: 'space-between', alignSelf: 'flex-end' }}>
                        ...
                        <Image style={{ width: 24, height: 24 }} source={require('../../assets/images/message.png')}></Image>
                        <Image style={{ width: 24, height: 24 }} source={require('../../assets/images/notification.png')}></Image>
            ...
            <ScrollView style={{marginBottom:90}}>
                ...
                >
                    ...
                    <TextInput
                        ...
                        style={{ flex: 3, backgroundColor: Colors.grayview, borderRadius: 10 }} />
                    <TextInput
                        placeholder="25 km"
                        style={{ flex: 2, marginStart: 15, backgroundColor: Colors.grayview, borderRadius: 10 }} />

                    <Image source={require('../../assets/images/back.png')} style={{ width: 32, height: 32, marginRight: 5, flex: 1, marginStart: 13, resizeMode: 'center' }} />
