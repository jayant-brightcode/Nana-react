                        ...
                        <View style={{flexDirection:'row',marginTop:4}}>
                            ...
                            <View style={{marginStart:10,marginTop:10}}>
                                <View style={{flexDirection:'row'}}>
                                    <Image style={{ width: 13, height: 13,tintColor:Colors.navcolor }} source={require('../../assets/images/like.png')}></Image>
...
{/* 
                ...
                <View style={{ marginStart: 10, marginEnd: 10, marginTop: 10, flexDirection: 'row' }}>
                    ...
                    <Text style={{ color: Colors.textcolor, fontSize: 15, fontWeight: 'medium', flex: 10, marginTop: 4 }}>All Employees</Text>
                    <Text style={{ marginStart: 13, flex: 3, width: 120, backgroundColor: Colors.dark_gray, padding: 3, textAlign: 'center' }}>view all</Text>
