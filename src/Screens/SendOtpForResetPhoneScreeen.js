...
const SendOtpForResetPhoneScreen = () => {
  ...
  // return;
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigation.replace("ResetPhoneNumberOtpScreen", { cred: data })
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.text}>Update Phone Number</Text>
        <Text style={{ color: Colors.dark_gray, fontWeight: 'bold', fontSize: 15 }}>don't worry!!</Text>
        ...
        <View >
          ...
          <TextInput maxLength={10} keyboardType='number-pad' style={{backgroundColor:Colors.grayview,borderRadius:10,padding:10}} placeholder="Enter your New Phone Number" value={email} onChangeText={(text) => setEmail(text)} />
...
export default SendOtpForResetPhoneScreen;
