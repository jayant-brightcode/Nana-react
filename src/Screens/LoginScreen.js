...
GoogleSignin.configure({
  webClientId: '7011689699-pkaq8qp6n0ukj677ig6sis7r4ij3o59b.apps.googleusercontent.com',
});
...
const LoginScreen = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      const googleCredential = GoogleAuthProvider.credential(userInfo.idToken, null);
    ...
    <View style={styles.container}>
      ...
      <View style={{ padding: 20, marginTop: '2%' }}>
       ...
       <View style={{flexDirection:'row',alignSelf:'center', marginTop: '3%'}}>
        ...
        <Text style={{ color: Colors.textcolor, fontWeight: 'medium', fontSize: 15 }}>Forgot Password?</Text>
