...
const TermsScreen = () => {
    ...
    const get_terms = async () => {
        ...
        try {
            ...
            let apiUrl = Remote.BASE_URL + "get_terms"
            ...
            if (response.ok) {
                ...
                set_terms(data.terms_and_condtion.terms_and_condition);
           ...
           <View style={styles.topbar}>
            <View style={{ flexDirection: 'row', marginTop: Platform.OS=="android"?10:0, padding: 10, alignItems: 'center' }}>
                ...
                <View style={{ marginStart: 15, flex: 1 }}>
                    <Text style={{ color: Colors.white, fontWeight: 'bold', fontSize: 20 }}>Terms and Condtions</Text>
