...
const SendOtpForResetEmailScreen = () => {
  ...
  // return;
    ...
    try {
      ...
      setLoading(true)
      const apiUrl = Remote.BASE_URL+"user/SendOtpForChangeEmailAddress";
      ...
      if (response.ok) {
        ...
        navigation.replace("ResetEmailOtpScreen", { cred: data })
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View >
          ...
          <TextInput style={{backgroundColor:Colors.grayview,borderRadius:10,padding:10}} placeholder="Enter your New Email Address" value={email} onChangeText={(text) => setEmail(text)} />
...
export default SendOtpForResetEmailScreen;
